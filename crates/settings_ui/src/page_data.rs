...
fn appearance_page() -> SettingsPage {
    ...
    fn cursor_section() -> [SettingsPageItem; 9] {
        [
            ...
            SettingsPageItem::SettingItem(SettingItem {
                title: "Smooth Cursor",
                description: "Animate the local cursor toward its real position.",
                field: Box::new(SettingField {
                    ...
                    pick: |settings_content| {
                        settings_content
                            ...
                            .smooth_cursor
                            .as_ref()
                            .and_then(|smooth_cursor| smooth_cursor.enabled.as_ref())
                    },
                    write: |settings_content, value, _| {
                        settings_content
                            .editor
            ...
            SettingsPageItem::SettingItem(SettingItem {
                title: "Cursor Trail",
                description: "Draw a smear trail behind the animated cursor.",
                field: Box::new(SettingField {
                    ...
                    pick: |settings_content| {
                        settings_content
                            ...
                            .smooth_cursor
                            .as_ref()
                            .and_then(|smooth_cursor| smooth_cursor.trail.as_ref())
                    },
                    write: |settings_content, value, _| {
                        settings_content
                            .editor
                ...
                field: Box::new(SettingField {
                    ...
                    pick: |settings_content| {
                        settings_content
                            ...
                            .smooth_cursor
                            .as_ref()
                            .and_then(|smooth_cursor| smooth_cursor.smooth_time.as_ref())
                    },
                    write: |settings_content, value, _| {
                        settings_content
                            .editor
            ...
            SettingsPageItem::SettingItem(SettingItem {
                title: "Cursor Trail Opacity",
                description: "Opacity of the smear trail from 0.0 to 1.0.",
                field: Box::new(SettingField {
                    ...
                    pick: |settings_content| {
                        settings_content
                            ...
                            .smooth_cursor
                            .as_ref()
                            .and_then(|smooth_cursor| smooth_cursor.trail_opacity.as_ref())
                    },
                    write: |settings_content, value, _| {
                        settings_content
                            .editor
